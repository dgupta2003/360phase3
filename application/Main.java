...
//
//		//creating the three buttons for taking the user to different views: Receptionist, Technician & Patient
...
//	    //Label visitDateLabel = new Label("Visit Date:");
...
//
//	        // Add visit date to patient
////	        if (visitDate != null) {
////	        	System.out.println(visitDate.toString());
////	            //patient.addVisitDate(java.sql.Date.valueOf(visitDate));
////	        }
//
//	        // Optionally, validate and process height, weight, blood pressure
//
...
//		//primaryStage.setScene(newPScene1);
//	}
//
...
//	    visitDatesTextArea.setEditable(false);
//
//	    // Buttons for prescribing medication and scheduling appointment
//	    Button prescribeMedicationButton = new Button("Prescribe Medication");
//	    prescribeMedicationButton.setOnAction(e -> {
//	        // Implement medication prescribing functionality
//	    });
//
...
//
//	    Button backButton = new Button("Back");
//	    backButton.setOnAction(e -> primaryStage.setScene(docLgnScene));
//
//	    layout.getChildren().addAll(titleLabel, usernameLabel, firstNameLabel, lastNameLabel,
//	            birthdayLabel, emailLabel, phoneNumberLabel, insuranceIdLabel,
//	            new Label("Health History:"),
...
//	    layout.setAlignment(Pos.CENTER);
//
//	    Scene doctorPatientDashboardScene = new Scene(layout, 600, 400);
//	    primaryStage.setScene(doctorPatientDashboardScene);
//	}
//	
...
//	        }
	...
	private void createDoctorPatientDashboardScene(Patient patient) {
	    ...
	    //TextField nextOfKinField = new TextField(patient.getNextOfKinPhoneNumber());
...
//	    nextOfKinField.setEditable(false);
...
//	    patientInfoGrid.addRow(4, addressLabel, addressField);
//	    patientInfoGrid.addRow(5, nextOfKinLabel, nextOfKinField);
...
//	            String enteredPassword = passWord.getText();
//
//	            //Patient existingPatient = retrievePatientInfo(enteredUsername);
//	            Patient patient = readPatientFromFile(enteredUsername + "_PatientInfo.txt");
//	            System.out.println(patient.toString());
//
//	            if (patient != null && patient.getPassword().equals(enteredPassword)) {
...
//		public static Patient readPatientFromFile(String fileName) {
//	        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
//	            String line;
//	            
...
////	                            try {
////	                                Date visitDate = sdfDateTime.parse(dateString.trim());
...
//	                        	//patient.addHealthRecord("No health history recorded\n");
//	                        }else {
//	                        	String[] healthHistoryRecords = value.split(",");
//		                        for (String record : healthHistoryRecords) {
//		                            patient.addHealthRecord(record.trim());
//		                        }
//	                        }
//	                        break;
//	                    case "Visit Dates":
////	                        String[] visitDateStrings = value.split(",");
////	                        for (String dateString : visitDateStrings) {
////	                            try {
////	                                Date date = sdf.parse(dateString.trim());
////	                                patient.addVisitDate(date);
////	                            } catch (ParseException e) {
////	                                e.printStackTrace();
////	                            }
////	                        }
